...
public class PropertyDialog extends AnchorPane {
    ...
    private final ObservableList<PropertyData> propertyDatas = FXCollections.observableArrayList();
    ...
    public interface OnPropertyDialogActionListener {
        void onInit(ObservableList<PropertyData> propertyDatas, TitledPane mTitledPane);

        void onOkDialogAction(ObservableList<PropertyData> propertyDatas);

        void onAddPropertyAction();

        void onDeletePropertyAction();
    }
}
